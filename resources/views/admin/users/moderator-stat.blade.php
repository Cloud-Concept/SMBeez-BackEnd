        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    @endif
                    <h3>Today's Call Center Reports for Agent "{{$user->first_name}} {{$user->last_name}}"</h3>
                    <br>
                    ...
                    <h3>Overall Call Center Reports for Agent "{{$user->first_name}} {{$user->last_name}}"</h3>
                    <br>
                    <div class="row equal overview-blocks">
                        <div class="col-md-6">
                            <div class="project-box box-block mb-3">
                    ...
                    <form action="{{route('admin.user.mod_stat', $user->username)}}" method="get">
                    ...
                    <h3>From "{{request()->query('date_from')}}" To "{{request()->query('date_to')}}" for Agent "{{$user->first_name}} {{$user->last_name}}"</h3>
                    <br>
                    <div class="row equal overview-blocks">
                        <div class="col-md-6">
                            <div class="project-box box-block mb-3">
